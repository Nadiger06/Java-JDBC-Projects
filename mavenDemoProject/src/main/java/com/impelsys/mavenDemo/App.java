...
System.out.println("Emp name: "+ bean.getName() +"  has got "+ bean.getLaptopDevice().getModelNum()+" ");
bean.setName("Mr. Sarvesh");
...
System.out.println("Emp name: "+ bean2.getName() +"  has got "+ bean2.getLaptopDevice().getModelNum()+" ");
	}
